...
(18, '教程', 'http://docs.epii-admin.epii.cn/704402', 1, '', 100, 0, 'fa fa-circle-o text-info', NULL, NULL, 1),
(7, '样式(adminlite3)', 'http://epii.gitee.io/adminlite3/', 1, '', 100, 0, 'fa fa-circle-o text-danger', NULL, NULL, 1);
