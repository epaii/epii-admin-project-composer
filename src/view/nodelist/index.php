...
<div class="content">
    ...
    <div class="card-body table-responsive" style="padding-top: 0px">
        <a class="btn btn-info  btn-outline-info btn-table-tool btn-dialog" href="{:url('user/Nodelist/add')}" data-area="70%,70%" title="新增节点">新增</a>
    </div>
    <div class="card-body table-responsive" style="padding-top: 0px">
        <table data-table="1" data-url="{:url('user/Nodelist/ajaxdata')}" id="table1" class="table table-hover">
            <thead>
            <tr>
